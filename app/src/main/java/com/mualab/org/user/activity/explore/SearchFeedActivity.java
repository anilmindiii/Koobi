...
import com.mualab.org.user.Views.fragnev.FragNavController;
...
public class SearchFeedActivity extends AppCompatActivity implements BaseFragment.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   if (exSearchTag.imageUrl!=null && !exSearchTag.imageUrl.equals("")) {
            Picasso.with(SearchFeedActivity.this).load(exSearchTag.imageUrl).placeholder(R.drawable.default_placeholder).
...
*/
    ...
    private void updateToolbar() {
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.white_back_ico);
    }
