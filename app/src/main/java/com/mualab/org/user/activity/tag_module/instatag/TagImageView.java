    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       Drawable drawable = getDrawable();
        ...
        if (adjustViewBounds) {
            ...
            /*AppLogger.e("View WH1", widthMode + " " + heightMode);
            AppLogger.e("View WH2", drawableWidth + " " + drawableHeight);
            AppLogger.e("View WH3", widthSize + " " + heightSize);*/
            ...
            if (heightMode == MeasureSpec.EXACTLY && widthMode != MeasureSpec.EXACTLY) {
                ...
                //AppLogger.e("WH Step2", width+" "+height);
                ...
                //AppLogger.e("WH Step3", width+" "+height);
            } else {
                super.onMeasure(widthMeasureSpec, heightMeasureSpec);
               // AppLogger.e("WH Step4", widthMeasureSpec + " " + heightMeasureSpec);
            }
        } else {
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
